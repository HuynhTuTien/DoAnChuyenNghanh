...
class CreateStaffRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'email' => 'required|string|email|max:255|unique:admin_staff,email', // Kiểm tra email duy nhất trong bảng admin_staff
            'phone' => [
                'required',
                'string',
                'size:10',  // Yêu cầu độ dài 10 ký tự
                'unique:admin_staff',  // Đảm bảo số điện thoại là duy nhất trong bảng admin_staff
            ...
            'role' => 'required|string|in:staff', // Chỉ cho phép vai trò 'staff'
            ...
            'can_cuoc' => ['required', 'regex:/^\d{12}$/', 'unique:admin_staff,can_cuoc'], // Kiểm tra định dạng CCCD và duy nhất trong bảng admin_staff
            'que_quan' => 'required|string|max:255',  // Quê quán là bắt buộc
            'chuc_vu' => 'required|string|max:255',   // Chức vụ là bắt buộc cho nhân viên
        ];
    }
