    ...
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    {{-- <li><a href="{{ route('order.detail') }}">Chi tiết đơn hàng</a>
            </li> --}}
        ...
        <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
            <div class="menu-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.03 20 4 16.97 4 12C4 7.03 7.03 4 12 4C16.97 4 20 7.03 20 12C20 16.97 16.97 20 12 20ZM10 16V14H14V16H10ZM10 10V8H14V10H10Z"
                        fill="#90959F" />
                </svg>
            </div>
        ...
        <ul aria-expanded="false">
            <li><a href="{{ route('supplier.list') }}">Danh sách nhà cung cấp</a></li>
        </ul>
        </li>
        ...
        <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
            ...
            <span class="nav-text">Nguyên liệu</span>
        </a>
        <ul aria-expanded="false">
            <li><a href="{{ route('ingredient.list') }}">Danh sách nguyên liệu</a></li>
            <li><a href="{{ route('ingredient.entryForm') }}">Nhập nguyên liệu</a></li>
            <li><a href="{{ route('ingredient.entry.list') }}">Lịch sử nhập nguyên liệu</a></li>
        </ul>
        </li>
